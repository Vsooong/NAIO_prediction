...
class ConvLSTM(nn.Module):
    ...
    # inputs: S*B*C*H*W
    def forward(self, inputs=None, states=None, seq_len=cfg.GLOBAL.IN_LEN):
...
if __name__ == '__main__':
    ...
    input = torch.rand(3, 8, 3, 256, 256).to(cfg.GLOBAL.DEVICE)
    model = ConvLSTM(input_channel=3, num_filter=8, b_h_w=(8, 256, 256), kernel_size=3)
    model = model.to(cfg.GLOBAL.DEVICE)
